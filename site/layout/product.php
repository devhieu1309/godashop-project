<div class="relative flex flex-col items-center justify-center group">
    ...
    <div class="">
        ...
        <div class="flex space-x-2">
            ...
            <?php endif ?>
            <p class="text-red-600 font-medium"><?php echo number_format($product->getSalePrice()) ?>đ</p>
        </div>
    </div>
    <div class="opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out flex-col space-y-2 items-center absolute left-10 top-10">
